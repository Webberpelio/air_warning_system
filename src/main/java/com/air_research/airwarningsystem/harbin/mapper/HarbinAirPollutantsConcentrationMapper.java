package com.air_research.airwarningsystem.harbin.mapper;
 ...
 * @since 2022-05-17
 */
public interface HarbinAirPollutantsConcentrationMapper extends BaseMapper<HarbinAirPollutantsConcentration> {
    ...
    @Select("select pred_date as 'predDate', pm25 as 'pm25', pm10 as 'pm10', " +
            ...
            "from tb_harbin_air_pollutants_concentration " +
